# -*- coding: utf-8 -*-
"""
Created on Thu Sep 12 16:12:17 2024
...
print('| ------ | --------- | --------- | -------------- |')
for idx, n_cases in enumerate(n_covid):
    ratio = (n_cases / sum_covid) * 100
    print('| %s | %d | %.1f | %.1f |' % (regions[idx], n_cases, ratio, norm_covid[idx]))
print('')